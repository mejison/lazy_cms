	...
	<body>
		<div class='top'>
			<div class='site'>
				<div class='logo_box'>
					<div class='project'>
						<a href='http://ships.div-art.com.ua/' class='link_project' target='_blank' title=''><span class='logo'></span>SlavonianBeauty.com</a>
					</div>
					<?php echo $this->blocks->put("access_signout"); ?>
				</div>
				<?php echo $this->blocks->put("menus_menu"); ?>
			</div>
		</div>
		...
		<div class='content'>
			<div class='site'>
				<div class='pages_title'>
					<?php echo $this->blocks->put("menus_title"); ?>
				</div>
				
				<div class='sep_20 clear'>
				</div>
